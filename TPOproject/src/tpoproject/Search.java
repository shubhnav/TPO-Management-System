...
public class Search extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Higher Secondary");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { ">=50", ">=60", ">=70" }));

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { ">=50", ">=60", ">=70" }));
